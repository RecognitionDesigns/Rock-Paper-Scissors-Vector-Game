...
def main():
    time.sleep(0.3)
    robot1.behavior.say_text("Robot 1 Ready!")
...
def robot1choice():
    ...
    if choice1==1:
        ...
        f= open("game_data/robotchoice1.txt","w+")
        f.write("rock")
        f.close()
        time.sleep(2)
        rock1()
    ...
    if rc1.mode == 'r':
        ...
        if rc2.mode == 'r':
            ...
            if robotchoice1 == robotchoice2:
                ...
                if os.path.isfile('game_data/winner.txt') == True:
            ...
            if robotchoice1 == "rock" and robotchoice2 == "paper":
                robotWinner = "robot2"
                robot1.behavior.say_text((robotchoice2) + "beats" + (robotchoice1))
                time.sleep(2)
            ...
            if robotchoice2 == "rock" and robotchoice1 == "paper":
                robotWinner = "robot1"
                robot1.behavior.say_text((robotchoice1) + "beats" + (robotchoice2) + ", I Won!")
